...
export function showGlogalDialog(props: IShowGlobalDialogProps) {
  ...
  const handleLeft = () => {
    playSe('playSeClickDialogButton');
    props.leftFunc();
    hideGlobalDialog();
  };
  const handleRight = () => {
      ...
      <div className={styles.glabalDialog_container}>
        <div className={styles.glabalDialog_container_inner}>
          ...
          <div className={styles.button_list}>
            <div className={styles.button} onClick={handleLeft} onMouseEnter={() => playSe('playSeEnterDialogButton')}>
              {props.leftText}
            </div>
            <div className={styles.button} onClick={handleRight} onMouseEnter={() => playSe('playSeEnterDialogButton')}>
              {props.rightText}
            </div>
          </div>
        </div>
